...
#define TD_REG_LOGUP (1)//регистрация - клавиша logup
#define TD_REG_NICKNAME (2)//регистрация - никнейм игрока
#define TD_REG_PASSWORD (3)//регистрация - пароль
...
#define TD_REG_CHARACTER (7)//регистрация - preview model скин
#define TD_REG_ARROW_LEFT (8)//регистрация - <
#define TD_REG_ARROW_RIGHT (9)//регистрация - >
...
public OnGameModeInit(){// Запускаем игровой мод
	...
	SetGameModeText("Doshirak v0.010.r3");//Ставим название мода для клиента
	    ...
	    case dRegistrationEmail:{//Если dialogid равен двойке, то переходим в тело
	        if(response){//Если ответ от диалога равен истинее (левая кнопка), то...
				...
				if(cache_get_row_count(mysql_connection)){// Если ответ равен истинне, либо больше, то...
					...
					mysql_query(mysql_connection,query,false);//Отправляем запрос
